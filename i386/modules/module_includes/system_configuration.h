...
#define __UCLIBCXX_SUBLEVEL__ 2
...
#define __UCLIBCXX_SUPPORT_CDIR__ 0
#define __UCLIBCXX_SUPPORT_CIN__ 0
#define __UCLIBCXX_SUPPORT_COUT__ 0
#define __UCLIBCXX_SUPPORT_CERR__ 0
 ...
 */
#define __UCLIBCXX_RUNTIME_PREFIX__ "."
